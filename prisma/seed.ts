...
async function main() {
  ...
  const products = [
    { slug: 'apple-iphone-16-pro', name: 'iPhone 16 Pro', variant: 'Natural Titanium, 256GB', mrp: 134900, price: 127400, imageUrl: '/iphone-16-pro.jpg', emiPlans: appleEmiPlans },
    { slug: 'apple-iphone-17-pro', name: 'iPhone 17 Pro', variant: 'Blue Titanium, 256GB', mrp: 144900, price: 137400, imageUrl: '/iphone-17-pro.jpg', emiPlans: appleEmiPlans },
    { slug: 'samsung-galaxy-s24-ultra', name: 'Samsung Galaxy S24 Ultra', variant: 'Titanium Violet, 256GB', mrp: 129999, price: 119999, imageUrl: '/samsung-s24-ultra.jpg', emiPlans: defaultEmiPlans },
    { slug: 'samsung-galaxy-s25-ultra', name: 'Samsung Galaxy S25 Ultra', variant: 'Titanium Yellow, 256GB', mrp: 139999, price: 129999, imageUrl: '/samsung-s25-ultra.jpg', emiPlans: defaultEmiPlans },
  ];
